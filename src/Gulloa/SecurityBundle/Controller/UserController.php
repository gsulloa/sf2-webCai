...
use Gulloa\SecurityBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GulloaSecurityBundle:User')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $encoded = $encoder->encodePassword($entity, $pass);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GulloaSecurityBundle:User')->find($id);
